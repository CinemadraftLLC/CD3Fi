...
contract CD3FiToken is Context, IERC20, Ownable {
    ...
    event Trade(
        uint256 refTax,
        uint256 rewardTax,
        uint256 stabilityTax,
        uint256 marketingTax,
        uint256 buyBackBurnTax,
        uint256 amountIn,
        uint256 amountOut);
    ...
    //APESWAP Mainnet: 0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7
    //APESWAP Testnet: 0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1

    address public router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

    //BUSD Mainnet : 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56

    //Pancake BUSD Testnet : 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
    //APESWAP BUSD Testnet : 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee
    ...
    uint256 private maxBracketTax = 75;                       // max bracket is holding 75%
    uint256 private taxBracketMultiplier = 10;
    ...
    function addRouter(address newAddress) public onlyOwner {
        ...
        lpContracts.push(_np);
    }

    function setLpPair(address _router) public onlyOwner {  //remove lp router
        IUniswapV2Router02 _Router = IUniswapV2Router02(_router);
        address _pair = IUniswapV2Factory(_Router.factory()).getPair(address(this), _Router.WETH());
        AutomaticMarketPair[_pair] = false;
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        emit Trade(_taxFee,_rewardFee,_stabilityFee,_MarketingFee,_buybackburnFee,tAmount,tTransferAmount);
    }
